					...
					if ( ! object.frustumCulled || _frustum.intersectsObject( object ) ) {
						...
						if ( sortObjects ) {
							...
							if ( object.boundingSphere !== undefined ) {
								...
								if ( !object.boundingSphere ) object.boundingSphere = new Vector4();
								_vector4.copy( object.boundingSphere.center || object.boundingSphere );

							} else {

								if ( geometry && geometry.boundingSphere == null ) geometry.computeBoundingSphere();
								if ( geometry && !geometry.boundingSphere ) geometry.boundingSphere = new Vector4();
								_vector4.copy( (geometry && geometry.boundingSphere) ? (geometry.boundingSphere.center || geometry.boundingSphere) : new Vector4() );
